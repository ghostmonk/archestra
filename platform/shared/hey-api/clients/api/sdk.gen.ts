 ...
 * `llmCost:read`: View LLM usage cost statistics and analytics
 */
export const getCostHealth = <ThrowOnError extends boolean = false>(options?: Options<GetCostHealthData, ThrowOnError>) => (options?.client ?? client).get<GetCostHealthResponses, GetCostHealthErrors, ThrowOnError>({ url: '/api/statistics/cost-health', ...options });
